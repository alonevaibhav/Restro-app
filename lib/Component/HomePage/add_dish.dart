...
//                         isFilterIcon: true,
//                         isSelected: controller.selectedCategory.value == 'filter'),
//                     SizedBox(width: 6.w),
//                     _buildFilterChip('favorites', controller,
//                         isSelected: controller.selectedCategory.value == 'favorites'),
//                     SizedBox(width: 6.w),
//                     _buildFilterChip('indian', controller,
//                         isSelected: controller.selectedCategory.value == 'indian'),
//                     SizedBox(width: 6.w),
//                     _buildFilterChip('Liquor', controller,
//                         isSelected: controller.selectedCategory.value == 'Liquor'),
//                     SizedBox(width: 6.w),
//                     _buildFilterChip('Beverages', controller,
//                         isSelected: controller.selectedCategory.value == 'Beverages'),
//                   ],
//                 )),
//               ),
//               SizedBox(height: 12.h),
...
//
//   void _loadItems() {
//     // Simplified to just 2 dishes per category as requested
//     allItems.addAll([
